...
async def add_global_csp(request: Request, call_next):
    ...
    response.headers["Content-Security-Policy"] = (
        ...
        "connect-src 'self' https://esm.sh https://storage.cloud.google.com https://storage.googleapis.com https://*.storage.googleapis.com https://*.googleusercontent.com; "
        "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; "
        "font-src 'self' https://fonts.gstatic.com; "
        "img-src 'self' data: blob: https://google-ai-skin-tone-research.imgix.net https://storage.cloud.google.com https://storage.googleapis.com https://*.storage.googleapis.com https://*.googleusercontent.com https://accounts.google.com; "
        "media-src 'self' https://deepmind.google https://storage.cloud.google.com https://storage.googleapis.com https://*.storage.googleapis.com https://*.googleusercontent.com; "
